...
$query_categories = "select * from categories order by CategoryID desc limit ";
...
if (isset($_POST['submit'])) {
    $query = "insert into categories(CategoryName) values('" . $_POST['categoryNameText'] . "')";
    if (!mysqli_query($conn, $query))
        echo $sql . "<br>" . mysqli_error($conn);
    else
        header("Location:" . "./them-the-loai.php");
}
                                ...
                                <div class="card-body align-items-center d-flex justify-content-center">
                                    <div class="pagination">
                                        ...
                                        if ($current_page > 1 && $total_page > 1) {
                                            echo '<a href="them-the-loai.php?page=' . ($current_page - 1) . '">&laquo</a>';
                                        }
                                        for ($i = $min; $i <= $max; $i++) {
                                            if ($i == $current_page) {
                                                echo '<a href="them-the-loai.php?page=' . $i . '" class="active">' . $i . '</a>';
                                            } else {
                                                echo '<a href="them-the-loai.php?page=' . $i . '">' . $i . '</a>';
                                            }
                                        }
                                        if ($current_page < $total_page && $total_page > 1) {
                                            echo '<a href="them-the-loai.php?page=' . ($current_page + 1) . '">&raquo</a>';
                                        }
                                        ?>
                                    </div>
                                </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <form class="forms-sample" method="POST">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="categoryNameText" required />
                                        </div>
...
<script>
    ...
    function cancel() {
        var categoryNameText = document.getElementsByName("categoryNameText");
