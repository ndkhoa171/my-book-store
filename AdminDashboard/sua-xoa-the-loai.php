...
//PAGING
$result = mysqli_query($conn, 'select count(CategoryID) as total from categories');
...
$query_categories = "select * from categories limit ";
$query_categories .= $start;
$query_categories .= ",";
$query_categories .= $limit;
...
//UPDATE
if (isset($_POST['edit'])) {
    $query_update = "update categories set CategoryName= '" . $_POST['categoryNameText'] . "' where CategoryID= " . $_POST['categoryIdText'] . "";
    if (!mysqli_query($conn, $query_update))
        echo $sql . "<br>" . mysqli_error($conn);
    else
        header("Location:" . "./sua-xoa-the-loai.php");
}

//DELETE
if (isset($_POST['delete'])) {
    $query_delete = "delete from categories where CategoryID= " . $_POST['categoryIdText'] . "";
        ...
        <div class="container-fluid page-body-wrapper">
            ...
            <nav class="sidebar sidebar-offcanvas" id="sidebar">
                <ul class="nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="../thongke/thong-ke.php">
                                ...
                                <div class="card-body align-items-center d-flex justify-content-center">
                                    <div class="pagination">
                                        ...
                                        if ($current_page > 1 && $total_page > 1) {
                                            echo '<a href="sua-xoa-the-loai.php?page=' . ($current_page - 1) . '">&laquo</a>';
                                        }
                                        for ($i = $min; $i <= $max; $i++) {
                                            if ($i == $current_page) {
                                                echo '<a href="sua-xoa-the-loai.php?page=' . $i . '" class="active">' . $i . '</a>';
                                            } else {
                                                echo '<a href="sua-xoa-the-loai.php?page=' . $i . '">' . $i . '</a>';
                                            }
                                        }
                                        if ($current_page < $total_page && $total_page > 1) {
                                            echo '<a href="sua-xoa-the-loai.php?page=' . ($current_page + 1) . '">&raquo</a>';
                                        }
                                        ?>
                                    </div>
                                </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <form class="forms-sample" method="POST">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="categoryIdText" id="categoryIdText" required readonly />
                                        </div>
                                        <div class="form-group">
                                            <label>Tên thể loại</label>
                                            <input type="text" class="form-control" name="categoryNameText" id="categoryNameText" required />
                                        </div>
...
<script>
    $('.table tbody').on('click', '.btn-secondary', function() {
        ...
        $("#categoryIdText").val(col0.trim());
        $("#categoryNameText").val(col1.trim());
    })
