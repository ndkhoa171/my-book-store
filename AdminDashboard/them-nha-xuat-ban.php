...
$query_publishingcompanys = "select * from publishingcompanys order by PublishingCompanyID desc limit ";
...
if (isset($_POST['submit'])) {
    $query = "insert into publishingcompanys(PublishingCompanyName) values('" . $_POST['publishingCompanyNameText'] . "')";
    if (!mysqli_query($conn, $query))
        echo $sql . "<br>" . mysqli_error($conn);
    else
        header("Location:" . "./them-nha-xuat-ban.php");
}
        ...
        <div class="container-fluid page-body-wrapper">
            ...
            <nav class="sidebar sidebar-offcanvas" id="sidebar">
                <ul class="nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" data-toggle="collapse" href="#quanlinhasanxuat" aria-expanded="false" aria-controls="ui-basic">
                            <i class="menu-icon typcn typcn-coffee"></i>
                            <span class="menu-title">Quản lí nhà xuất bản</span>
                            <i class="menu-arrow"> </i>
                        </a>
                        <div class="collapse" id="quanlinhasanxuat">
                            <ul class="nav flex-column sub-menu">
                                <li class="nav-item">
                                ...
                                <div class="card-body align-items-center d-flex justify-content-center">
                                    <div class="pagination">
                                        ...
                                        if ($current_page > 1 && $total_page > 1) {
                                            echo '<a href="them-nha-xuat-ban.php?page=' . ($current_page - 1) . '">&laquo</a>';
                                        }
                                        for ($i = $min; $i <= $max; $i++) {
                                            if ($i == $current_page) {
                                                echo '<a href="them-nha-xuat-ban.php?page=' . $i . '" class="active">' . $i . '</a>';
                                            } else {
                                                echo '<a href="them-nha-xuat-ban.php?page=' . $i . '">' . $i . '</a>';
                                            }
                                        }
                                        if ($current_page < $total_page && $total_page > 1) {
                                            echo '<a href="them-nha-xuat-ban.php?page=' . ($current_page + 1) . '">&raquo</a>';
                                        }
                                        ?>
                                    </div>
                                </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <form class="forms-sample" method="POST">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="publishingCompanyNameText" required />
                                        </div>
...
<script>
    ...
    function cancel() {
        var publishingCompanyNameText = document.getElementsByName("publishingCompanyNameText");
        publishingCompanyNameText.values = "";
    }
</script>
